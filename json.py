...
json = """{
    ...
    },
    {
        ...
        "description": "The health and social care industry is one of the fastest growing in the UK – people are living longer and there is an increasing need for care and support as well as working with children in early years. By studying Health and Social Care you will learn how to help others improve their physical health and impact the wellbeing of people in your community as well as developing skills in working with young children. If you want to help make a positive difference to people’s lives then Health and Social Care is the   for you. The Extended Certificate is equivalent to 1 A Level and awards UCAS points towards university applications. You will develop professional and personal skills to allow you to offer specific, person-centred care and support and build positive relationships with the people you are working with, so that their needs and requirements are met while they maintain control of their own care and support. There is no requirement for work experience however we strongly recommend any work experience or part time work is related in some way to the sector.",
    ...
    },
    {
        ...
        "description": "The health and social care industry is one of the fastest growing in the UK – people are living longer and there is an increasing need for care and support as well as working with children in early years. By studying Health and Social Care you will learn how to help others improve their physical health and impact the wellbeing of people in your community as well as developing skills in working with young children. If you want to help make a positive difference to people’s lives then Health and Social Care is the   for you. In the first year you will study the Certificate and on successful completion you will continue onto the second year to complete the Extended Certificate or the Extended Diploma. You will develop professional and personal skills to allow you to offer specific, person-centred care and support and build positive relationships with the people you are working with, so that their needs and requirements are met while they maintain control of their own care and support.",
        "testimonials": "“It is an interesting and enjoyable   that covers a wide range of topics”\r\nMorgan, previously The Trafalgar School at Downton",
...
r = requests.post('http://127.0.0.1:5000', myList)
